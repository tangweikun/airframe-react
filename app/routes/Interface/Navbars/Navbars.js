			...
			<Row>
				<Col lg={12}>
					<HeaderDemo no={1} title="Navbars Light">
						Theming the navbar has never been easier thanks to Theme Providers. Wrap the <code>Navbar</code> with a{" "}
						<code>NavbarThemeProvider</code> component and set <code>style=&quot;light&quot;</code> and{" "}
			...
			<Row>
				<Col lg={12}>
					<HeaderDemo no={2} title="Navbars Dark" className="mt-5">
						Theming the navbar has never been easier thanks to Theme Providers. Wrap the <code>Navbar</code> with a{" "}
						<code>NavbarThemeProvider</code> component and set <code>style=&quot;dark&quot;</code> and{" "}
						<code>color=&quot;&lt;desired color&gt;&quot;</code>.
					</HeaderDemo>
			...
			<Row>
				<Col lg={12}>
					<HeaderDemo no={3} title="Navbars Color" className="mt-5">
						Theming the navbar has never been easier thanks to Theme Providers. Wrap the <code>Navbar</code> with a{" "}
						<code>NavbarThemeProvider</code> component and set <code>style=&quot;color&quot;</code> and{" "}
						<code>color=&quot;&lt;desired color&gt;&quot;</code>.
					</HeaderDemo>
