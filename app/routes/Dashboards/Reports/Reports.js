					...
					<CardBody className="bb-0">
						<span className="d-flex">
							...
							<span className="ml-auto justify-content-start">
								...
								<a href="#" id="TemperaturesTooltipAdd" className="text-decoration-none">
					...
					<CardBody className="bb-0">
						<span className="d-flex">
							...
							<span className="ml-auto justify-content-start">
								...
								<a href="#" id="UsageTooltipAdd" className="text-decoration-none">
									<i className="fa fa-fw fa-plus"></i>
								</a>
							</span>
							...
							<CardBody className="bb-0">
								<span className="d-flex">
									...
									<span className="ml-auto justify-content-start">
										...
										<a href="#" id="AllocationTooltipAdd" className="text-decoration-none">
											<i className="fa fa-fw fa-plus"></i>
										</a>
									</span>
							...
							<CardBody className="bb-0">
								<span className="d-flex">
									...
									<span className="ml-auto justify-content-start">
										...
										<a href="#" id="CoolingTooltipAdd" className="text-decoration-none">
											<i className="fa fa-fw fa-plus"></i>
										</a>
									</span>
