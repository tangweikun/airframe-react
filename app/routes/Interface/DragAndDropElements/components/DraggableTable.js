...
import { Table, Badge, Avatar, AvatarAddOn, Progress, Card, CardHeader, CardTitle } from "./../../../../components";
...
const DraggableRow = props => (
	<Draggable draggableId={props.id} index={props.index}>
		{(provided, snapshot) => (
			<tr ref={provided.innerRef} {...provided.draggableProps} className={getRowClass(snapshot.isDragging)}>
				<TableCell className="align-middle" isDragOccurring={snapshot.isDragging} {...provided.dragHandleProps}>
				...
				<TableCell className="align-middle" isDragOccurring={snapshot.isDragging}>
					<Avatar.Image
						...
						addOns={[
							...
							<AvatarAddOn.Icon className="fa fa-circle" color={props.status} key="avatar-icon-fg" />
						]}
					/>
				</TableCell>
				<TableCell className="align-middle" isDragOccurring={snapshot.isDragging}>
				...
				<TableCell className="text-right align-middle" isDragOccurring={snapshot.isDragging}>
					{!_.isEmpty(props.portfolio) ? <a href={props.portfolio.url}>{props.portfolio.title}</a> : <span>-</span>}
				</TableCell>
			</tr>
		)}
	</Draggable>
