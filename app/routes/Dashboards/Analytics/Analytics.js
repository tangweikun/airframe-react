...
const SessionByDevice = props => (
	<div className={classes["session"]}>
		...
		<div className={classes["session__values"]}>
			<div className={`${classes["session__percentage"]} text-${props.color}`}>{props.valuePercent}%</div>
				...
				<Container fluid={false}>
					<div className="d-flex mt-3 mb-5">
						...
						<ButtonToolbar className="ml-auto">
							...
							<ButtonGroup>
								<Button color="link" className="mb-2 text-decoration-none align-self-start" onClick={this._resetLayout}>
									Reset
								</Button>
							</ButtonGroup>
						</ButtonToolbar>
						...
						<Grid.Col {...applyColumn("metric-v-target-users", layouts)}>
							<Card>
								...
								<CardBody className="pt-2">
									<MetricVsTarget title="Users" value="168,793" progressbarColor="danger" targetValue="169,001" />
								</CardBody>
								<CardFooter>
							...
							<Card>
								...
								<CardBody className="d-flex flex-column">
									<div className={classes["sessions"]}>
										<SessionByDevice title="Desktop" color="purple" valuePercent="51,5" value="201,345" />
										<SessionByDevice title="Mobile" color="primary" valuePercent="34,4" value="134,201" />
										<SessionByDevice title="Mobile" color="success" valuePercent="20,8" value="81,525" />
									</div>
