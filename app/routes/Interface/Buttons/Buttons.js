...
const Buttons = () => (
	<React.Fragment>
		<Container>
			...
			<Row>
				<Col lg={12}>
					<HeaderDemo no={2} title="Buttons Layouts" className="mt-5" subTitle="Media list and media object layouts." />
				</Col>
			</Row>
			{/* END Header 3 */}
			{/* START Section 3 */}
			...
			<Row>
				<Col lg={12}>
					<HeaderDemo no={5} title="Buttons Styling" className="mt-5" subTitle="Media list and media object layouts." />
				</Col>
			</Row>
			{/* END Header 4 */}
			{/* START Section 4 */}
			...
			<Row>
				<Col lg={12}>
					<HeaderDemo no={4} title="Buttons States" className="mt-5" subTitle="Media list and media object layouts." />
				</Col>
			</Row>
			{/* END Header 5 */}
			{/* START Section 5 */}
			...
			<Row>
				<Col lg={12}>
					<HeaderDemo no={8} title="Buttons Options" className="mt-5" subTitle="Media list and media object layouts." />
				</Col>
			</Row>
			{/* END Header 8 */}
			{/* START Section 8 */}
