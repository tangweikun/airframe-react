		...
		return (
			<React.Fragment>
				...
				<ButtonToolbar className="mt-2">
					<Button outline color="secondary" onClick={() => this._typeahead.getInstance().clear()} className="mr-2">
						Clear
					</Button>
					<Button outline color="secondary" onClick={() => this._typeahead.getInstance().focus()} className="mr-2">
						Focus
					</Button>
					<Button
						outline
