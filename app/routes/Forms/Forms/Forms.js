						...
						<CardBody>
							...
							<Form>
								...
								<FormGroup row>
									...
									<Col sm={9}>
										<Input type="email" name="email" id="inputPasswordPlaceholder" placeholder="Placeholder..." />
									</Col>
								</FormGroup>
								{/* END Input */}
								{/* START Input */}
								<FormGroup row>
									...
									<Col sm={9}>
										<Input type="" name="email" id="inputPasswordReadonly" placeholder="Readonly Input..." readOnly />
									</Col>
								</FormGroup>
								{/* END Input */}
								{/* START Input */}
								<FormGroup row>
									...
									<Col sm={9}>
										<Input type="" name="" id="inputPasswordDisabled" placeholder="Disabled" disabled />
									</Col>
								</FormGroup>
								{/* END Input */}
								{/* START Select */}
							...
							<Form>
								...
								<FormGroup row>
									...
									<Col sm={9}>
										<Input type="select" name="select" id="multipleSelectDisabled" multiple disabled>
											<option>One</option>
											<option>Two</option>
											<option>Three</option>
											<option>Four</option>
								...
								<FormGroup row>
									...
									<Col sm={9}>
										...
										<FormText color="muted">
											This is some placeholder block-level help text for the above input. Its a bit lighter and easily
											wraps to a new line.
										</FormText>
									</Col>
								</FormGroup>
							...
							<Form>
								...
								<FormGroup row>
									...
									<Col sm={9} className="d-flex align-items-center">
										...
										<FormGroup check inline>
											<FormText className="align-self-center">Must be 8-20 characters long.</FormText>
										</FormGroup>
									</Col>
								</FormGroup>
								{/* END Input Inline */}
							...
							<Form>
								...
								<FormGroup row>
									...
									<Col sm={9}>
										<Input type="text" name="" id="inputValidation-1" placeholder="" valid defaultValue="Mark" />
								...
								<FormGroup row>
									...
									<Col sm={9}>
										<Input type="text" name="" id="inputValidation-2" placeholder="Username..." invalid />
								...
								<FormGroup row>
									...
									<Col sm={9}>
										<CustomInput type="select" name="customSelect" id="selectCustomValidation" invalid>
											<option defaultValue="">Open this Select Menu</option>
											<option>One</option>
											<option>Two</option>
											<option>Three</option>
								...
								<FormGroup row>
									...
									<Col sm={9}>
										<CustomInput type="file" id="fileInputStyleValidation" name="customFile" invalid />
									...
									<Col sm={9}>
										<Row>
											<Col sm={12} lg={4} className="mb-5 mb-md-0">
												<Input type="text" name="" id="validationTooltips-1" placeholder="" defaultValue="Mark" valid />
											...
											<Col sm={12} lg={4} className="mb-3 mb-md-0">
												<Input type="text" name="" id="validationTooltips-2" placeholder="" invalid />
							...
							<Form>
								...
								<FormGroup row>
									...
									<Col sm={9}>
										<Row>
											<Col sm={12} lg={4} className="mb-3 mb-md-0">
												<Input type="text" name="" id="largeSize-1" placeholder="Large (lg) Input" bsSize="lg" />
											</Col>
											<Col sm={12} lg={4} className="mb-3 mb-md-0">
								...
								<FormGroup row>
									...
									<Col sm={9}>
										<Row>
											<Col sm={12} lg={4} className="mb-3 mb-md-0">
												<Input type="text" name="" id="smSize-1" placeholder="Small (sm) Input" bsSize="sm" />
											</Col>
											<Col sm={12} lg={4} className="mb-3 mb-md-0">
										...
										<Form>
											<FormGroup>
												<CustomInput
													...
													defaultChecked
												/>
												<CustomInput type="checkbox" id="checkboxesStackedCustom2" label="Unchecked Checkbox Custom" />
												<CustomInput type="checkbox" id="checkboxesStackedCustom3" label="Disabled Checkbox Custom" />
											</FormGroup>
										</Form>
									</div>
									{/* END Checkboxes */}
										...
										<Form>
											<FormGroup>
												<CustomInput
													...
													defaultChecked
												/>
												<CustomInput type="checkbox" id="checkboxesInlineCustom2" label="Unchecked Custom" inline />
												<CustomInput
													type="checkbox"
