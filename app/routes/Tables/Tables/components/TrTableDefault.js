					...
					<Media>
						<Media left middle className="mr-3">
							<Avatar.Image
								...
								src={randomAvatar()}
								addOns={[
									<AvatarAddOn.Icon className="fa fa-circle" color={props.leaderStatus} key="avatar-icon-bg" />,
									<AvatarAddOn.Icon className="fa fa-circle" color={colorStatus[index % 4]} key="avatar-icon-fg" />
								]}
							/>
						</Media>
						<Media body>
