...
const cardText = ({ cardNo }) => (
	<CardText>
		<span className="mr-2 text-muted">#{cardNo}</span> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla
		nisl elit, porta a sapien eget, fringilla sagittis ex.
	</CardText>
);
			...
			<Row>
				...
				<Col lg={6}>
					...
					<div className="mb-5">
						...
						<p>
							The most basic list group is an unordered list with list items and the proper classes. Example:{" "}
					...
					<div className="mb-5">
						...
						<p>
							From the color palette, add to <code>&lt;ListGroupItem&gt;</code> for example: <code>success</code>,{" "}
							<code>primary</code> etc.
						</p>
						<ListGroup>
				...
				<Col lg={6}>
					...
					<div className="mb-5">
						...
						<p>
							The most basic list group is an unordered list with list items and the proper classes. Example:{" "}
							<code>&lt;ListGroupItem active tag="a" href="#" action&gt; ... &lt;/ListGroupItem&gt;</code>.
						</p>
						<ListGroup>
							<ListGroupItem active tag="a" href="#" action>
								Cras justo odio
								...
								<Media>
									<Media left top className="mr-4">
										<Avatar.Image
											...
											addOns={[
												<AvatarAddOn.Icon className="fa fa-circle" color="white" key="avatar-icon-bg" />,
												<AvatarAddOn.Icon className="fa fa-circle" color="warning" key="avatar-icon-fg" />
											]}
										/>
									</Media>
									<Media body>
								...
								<Media>
									...
									<Media right top>
										<Avatar.Image
											...
											addOns={[
												<AvatarAddOn.Icon className="fa fa-circle" color="white" key="avatar-icon-bg" />,
												<AvatarAddOn.Icon className="fa fa-circle" color="secondary" key="avatar-icon-fg" />
											]}
										/>
									</Media>
								</Media>
