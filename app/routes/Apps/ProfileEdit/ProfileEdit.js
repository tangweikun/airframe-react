								...
								<FormGroup row>
									...
									<Col sm={8}>
										<CustomInput
											...
											defaultChecked
										/>
										<CustomInput type="radio" id="operatingSystem22" name="afterLogging" label="Inactive" />
										<CustomInput type="radio" id="operatingSystem33" name="afterLogging" label="Busy" />
										<CustomInput type="radio" id="operatingSystem34" name="afterLogging" label="Offline" />
									</Col>
								</FormGroup>
