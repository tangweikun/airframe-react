						...
						<CardBody>
							...
							<UncontrolledButtonDropdown>
								...
								<DropdownMenu persist>
									...
									<DropdownItem>
										<CustomInput type="radio" id="DropdownLeftRadios2" name="DropdownLeftRadios" label="Compact" />
									</DropdownItem>
									<DropdownItem divider />
									<DropdownItem>
										<CustomInput type="radio" id="DropdownLeftRadios3" name="DropdownLeftRadios" label="Custom..." />
									</DropdownItem>
								</DropdownMenu>
							</UncontrolledButtonDropdown>
						</CardBody>
						...
						<CardBody>
							...
							<UncontrolledButtonDropdown>
								...
								<DropdownMenu persist>
									...
									<DropdownItem>
										<CustomInput type="checkbox" id="DropdownLeftCheckbox1" label="ReactJS" defaultChecked />
									</DropdownItem>
									<DropdownItem>
			...
			<Row>
				<Col lg={12}>
					<HeaderDemo
						...
						className="mt-5"
						subTitle={<React.Fragment>Dropdown as combo with Lists, Buttons, Input and Media...</React.Fragment>}
					/>
				</Col>
			</Row>
			{/* END Header 5 */}
