	...
	<Row>
		<Col md={6}>
			<div>
				...
				<p>
					Discover goods you&apos;ll love from brands that inspire. The easiest way to open your own online store.
	...
	<Row>
		<Col md={6}>
			<div>
				...
				<p>
					We respect your privacy and protect it with strong encryption, plus strict policies. Two-step verification,
	...
	<Row>
		<Col md={6}>
			<div>
				...
				<p className="pb-3">Below is a sample page for your cart , Created using pages design UI Elementes.</p>
				...
				<small>
					Invoice are issued on the date of despatch. Payment terms: Pre-orders: within 10 days of invoice date with 4%
					discount, from the 11th to the 30th day net. Re-orders: non-reduced stock items are payable net after 20 days.
				</small>
			</div>
		</Col>
		<Col md={6}>
	...
	<Row>
		<Col md={6}>
			<div>
				...
				<p className="mb-5">Below is a sample page for your cart , Created using pages design UI Elementes.</p>
				<Table className="my-2">
					<thead>
						<tr>
							<th>#</th>
