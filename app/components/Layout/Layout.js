...
const findChildrenByType = (children, targetType) => {
	return _.filter(React.Children.toArray(children), child => child.type.layoutPartName === targetType.layoutPartName);
};
...
class Layout extends React.Component {
	...
	componentDidUpdate(prevProps, prevState) {
		...
		if (
			...
			(this.state.screenSize === "xs" || this.state.screenSize === "sm" || this.state.screenSize === "md")
		) {
	...
	render() {
		...
		const otherChildren = _.differenceBy(React.Children.toArray(children), [sidebar, ...navbars, content], "type");
