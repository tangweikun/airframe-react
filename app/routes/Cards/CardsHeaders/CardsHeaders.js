...
const Cards = () => (
	<React.Fragment>
		<Container>
			...
			<Row>
				<Col lg={12}>
					<HeaderDemo no={1} title="Cards Headers - Text" subTitle="Provide contextual feedback messages" />
				</Col>
			</Row>
			{/* END Header 1 */}
			{/* START Section 1 */}
						...
						<UncontrolledTabs initialActiveTabId="users201a">
							<CardHeader>
								<Nav tabs className="card-header-tabs">
									...
									<NavItem>
										<UncontrolledTabs.NavLink tabId="settings201b">Settings</UncontrolledTabs.NavLink>
									</NavItem>
								</Nav>
							</CardHeader>
							<CardBody>
						...
						<UncontrolledTabs initialActiveTabId="users204a">
							<CardBody>
								<Nav pills className="mb-3">
									...
									<NavItem>
										<UncontrolledTabs.NavLink tabId="settings204b">Settings</UncontrolledTabs.NavLink>
									</NavItem>
								</Nav>
								<UncontrolledTabs.TabContent>
