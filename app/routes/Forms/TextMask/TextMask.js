...
export const TextMask = () => (
	<Container>
		...
		<p className="mb-3">
			Text Mask is an input mask library. It can create input masks for <code>phone</code>,<code>date</code>,{" "}
			<code>currency</code>, <code>zip code</code>, <code>percentage</code>, <code>email</code>, and literally anything!
		</p>
		<Card>
			<CardBody>
				<Row>
					...
					<Col lg={4}>
						<FormGroup>
							...
							<Input mask={[/[1-9]/, /\d/, /\d/, /\d/, /\d/]} placeholder="94303" tag={MaskedInput} id="uSZipCode" />
						</FormGroup>
					</Col>
