...
import { Card, CardImg, HolderProvider, Media, Avatar, AvatarAddOn, CardFooter, CardBody } from "./../../../components";
					...
					<Media left className="align-self-center mr-3">
						<Avatar.Image
							...
							addOns={[
								...
								<AvatarAddOn.Icon className="fa fa-circle" color={randomArray(status)} key="avatar-icon-fg" />
							]}
						/>
					</Media>
					<Media body>
