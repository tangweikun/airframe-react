				...
				<Card className="mb-3">
					<CardBody>
						...
						<TimelineMini
							...
							badgeColor="warning"
						/>
						<TimelineMini icon="info-circle" iconClassName="text-info" badgeTitle="Info" badgeColor="info" />
						<TimelineMini
							showPillDate
							pillDate="Yesterday"
							icon="plus-circle"
							...
							badgeColor="primary"
						/>
						<TimelineMini icon="check-circle" iconClassName="text-success" badgeTitle="Success" badgeColor="success" />
			...
			<Col lg={6}>
				...
				<Card className="mb-3">
					...
					<CardFooter className="small">
						...
						<abbr title="attribute">www.webkom.com</abbr> compare to your targets over the last 30 days?
					</CardFooter>
				</Card>
				{/* END Card Widget */}
				{/* START Card Widget */}
