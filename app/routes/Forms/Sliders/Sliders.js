		...
		return (
			<div>
				<Form inline className="mb-3 d-flex justify-content-between">
					...
					<FormGroup>
						<Button onClick={this.handleApply.bind(this)} type="button" color="primary" size="sm" block>
							Apply
						</Button>
					</FormGroup>
				</Form>
		...
		return (
			<Container>
				...
				<Row>
					<Col>
						{/* START Header 1 */}
						<HeaderDemo no={1} title="Marks" subTitle={<React.Fragment>See 6 examples below:</React.Fragment>} />
						{/* END Header 1 */}
						{/* START Card Example */}
						<Card>
							<CardBody>
