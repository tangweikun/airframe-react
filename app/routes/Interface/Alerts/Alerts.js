				...
				<Col lg={6}>
					...
					<div className="mb-4">
						...
						<Alert color="info">
							...
							<span>
								<strong className="alert-heading">Information!</strong> This alert needs your attention, but it's not
								important.
							</span>
						</Alert>
					</div>
				...
				<Col lg={6}>
					...
					<div className="mb-4">
						...
						<Alert color="dark">
							...
							<span>
								<strong className="alert-heading">Attention!</strong> This alert needs your attention, but it's not
								important.
							</span>
						</Alert>
					</div>
