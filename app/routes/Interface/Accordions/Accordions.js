...
const Accordions = () => (
	<React.Fragment>
		<Container>
			...
			<Row>
				...
				<Col lg={6}>
					...
					<div className="mb-5">
						...
						<p>
							Below is an example of default accordion based on <code>Card</code>, <code>h6</code>, and{" "}
			...
			<Row>
				<Col lg={12}>
					<HeaderDemo no={2} title="Accordions Styling" className="mt-5" subTitle="Basic button layout options" />
				</Col>
			</Row>
			{/* END Header 2 */}
			{/* START Section 2 */}
