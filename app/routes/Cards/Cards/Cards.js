...
import { Container, Row, Col, Card, CardHeader, CardBody, CardTitle, CardText } from "./../../../components";
...
const Cards = () => (
	<React.Fragment>
		<Container>
			...
			<Row>
				<Col lg={12}>
					<HeaderDemo no={1} title="Card Default Styles" subTitle="Available panel styles and colors" />
				</Col>
			</Row>
			{/* END Header 1 */}
			{/* START Section 1 */}
			...
			<Row>
				<Col lg={12}>
					<HeaderDemo no={2} title="Cards Borders" subTitle="Provide contextual feedback messages" className="mt-5" />
				</Col>
			</Row>
			{/* END Header 2 */}
			{/* START Section 2 */}
			...
			<Row>
				<Col lg={12}>
					<HeaderDemo no={6} title="Cards Various" subTitle="Provide contextual feedback messages" className="mt-5" />
				</Col>
			</Row>
			{/* END Header 6 */}
			{/* START Section 6 */}
