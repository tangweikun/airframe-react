				...
				<Col lg={12}>
					<Card className="mb-3">
						<CardBody>
							...
							<p className="mb-0">
								Using the most basic table markup, here’s how <code>.table-based</code> tables look in Bootstrap. All
								table styles are inherited in Bootstrap 4, meaning any nested tables will be styled in the same manner
								as the parent.
							</p>
						</CardBody>
						{/* START Table */}
					...
					<Card className="mb-3">
						<CardBody>
							...
							<p className="mb-0">
								...
								all viewports by wrapping a <code>Table</code> with <code>responsive</code>.
							</p>
						</CardBody>
						{/* START Table */}
						<Table className="mb-0" responsive>
				...
				<Col lg={12}>
					<Card className="mb-3">
						<CardBody>
							...
							<p className="mb-0">Use contextual classes to color table rows or individual cells.</p>
						</CardBody>
						{/* START Table */}
						<Table className="mb-0" hover responsive>
							<thead>
				...
				<Col lg={12}>
					<Card className="mb-3" type="background" color="dark">
						...
						<Table className="mb-0" dark responsive>
							...
							<tbody>
								<TrTableDefault projectColor="text-white" leaderStatus="900" dropdownColor="text-white" />
							</tbody>
						</Table>
						{/* END Table */}
					</Card>
