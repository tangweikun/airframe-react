...
export const SidebarDefault = () => (
	<Container>
		...
		<p className="mb-5">
			...
			<a href="https://getbootstrap.com" className="text-primary" target="_blank" rel="noopener noreferrer">
				Bootstrap 4.x
			</a>{" "}
			version for React called&nbsp;
			<a href="https://reactstrap.github.io" className="text-primary" target="_blank" rel="noopener noreferrer">
				reactstrap
			</a>{" "}
		...
		<section className="mb-5">
			...
			<p>
				...
				<a href="http://wbkom.co/contact" className="text-primary" target="_blank" rel="noopener noreferrer">
					webkom.co/contact
				</a>{" "}
				website.
			</p>
