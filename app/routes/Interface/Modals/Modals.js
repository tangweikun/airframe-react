		...
		<Row>
			<Col lg={12}>
				<HeaderDemo
					...
					title="Modal Sizes"
					className="mt-5"
					subTitle={<React.Fragment>There are three sizes of modals in the application.</React.Fragment>}
				/>
			</Col>
		</Row>
		{/* END Header 2 */}
		...
		<Row>
			<Col lg={12}>
				<HeaderDemo
					...
					subTitle={
						<React.Fragment>
							You can apply colors to make them easier to see for users. All colors work from the section
					...
					<CardBody className="table-info">
						...
						<UncontrolledModal target="modalDefault403" className="modal-info">
							...
							<ModalBody className="table-info text-center px-5">
								...
								<h6>Information</h6>
								<p className="modal-text">This alert needs your attention, but it's not important.</p>
