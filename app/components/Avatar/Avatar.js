...
const Avatar = props => {
	...
	const badge = _.find(addOnsdArr, avatarAddOn => avatarAddOn.type.addOnId === "avatar--badge");
	const icons = _.filter(addOnsdArr, avatarAddOn => avatarAddOn.type.addOnId === "avatar--icon");
	const isNested = _.reduce(addOnsdArr, (acc, avatarAddOn) => acc || !!avatarAddOn.props.small, false);
