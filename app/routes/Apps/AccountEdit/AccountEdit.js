				...
				<Col lg={9}>
						...
						<CardBody>
							...
							<Form>
								...
								<FormGroup row>
									...
									<Col sm={8}>
										<Input type="password" name="password" id="oldPassword" defaultValue="********" />
									</Col>
								</FormGroup>
								{/* END Input */}
								{/* START Input */}
								<FormGroup row>
									...
									<Col sm={8}>
										<Input type="password" name="password" id="newPassword" defaultValue="********" />
									</Col>
								</FormGroup>
								{/* END Input */}
								{/* START Input */}
								<FormGroup row className="mb-0">
									...
									<Col sm={8}>
										<Input type="password" name="password" id="confirmNewPassword" defaultValue="********" />
									</Col>
								</FormGroup>
								{/* END Input */}
								{/* START Input */}
					...
					<Card className="mb-3">
						<CardBody>
							...
							<p>
								Changing the username is not recommended. In this connection, I can appear <a href="#">many problems</a>
								.
							</p>
