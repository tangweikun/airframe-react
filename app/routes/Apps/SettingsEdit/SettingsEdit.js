						...
						<CardBody>
							...
							<Form>
								...
								<FormGroup className="mb-5">
									...
									<p className="mb-2">Do you want receive our monthly newsletter about new products and offers?</p>
								...
								<FormGroup className="mb-5">
									...
									<p className="mb-2">Do you want notify you by email whenever contacts send you a message?</p>
