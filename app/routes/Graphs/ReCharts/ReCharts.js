...
export const ReCharts = () => (
	<Container>
		...
		<p>
			Recharts is a Redefined chart library built with React and D3. The main purpose of this library is to help you to
			write charts in React applications without any pain. Main principles of Recharts are:
		</p>
		<ul className="mb-5">
			<li>
		...
		<Row>
			<Col lg={12}>
				<HeaderDemo
					...
					title="Bar Charts"
					subTitle={
						<React.Fragment>Quickly build your charts with decoupled, reusable React components.</React.Fragment>
					}
				/>
			</Col>
		</Row>
