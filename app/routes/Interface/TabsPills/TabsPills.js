...
import { Container, Row, Col, Card, CardTitle, CardBody, Nav, NavItem, NavLink, Badge } from "./../../../components";
				...
				<Col lg={6}>
					...
					<Card className="mb-3">
						<CardBody>
							...
							<p>
								Pills are also vertically stackable. Just add <code>vertical</code> to the <code>Nav</code>.
							</p>
							<Nav pills vertical>
								<NavItem>
									<NavLink href="#" active>
