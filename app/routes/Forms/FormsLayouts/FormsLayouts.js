			...
			<Row>
				<Col lg={12}>
					<HeaderDemo
						...
						subTitle={
							<React.Fragment>
								Create horizontal forms with the grid by adding the .row class to form groups and using the .col-*-*
						...
						<CardBody>
							...
							<Form>
								...
								<FormGroup row>
									...
									<Col sm={8}>
										<Input type="password" name="password" id="inputPassword-1" placeholder="Password..." />
									</Col>
								</FormGroup>
								{/* END Input */}
								{/* START Radios */}
								<FormGroup row>
									...
									<Col sm={8}>
										<CustomInput
											...
											defaultChecked
										/>
										<CustomInput type="radio" id="operatingSystem12" name="operatingSystem" label="Windows" inline />
										<CustomInput
											type="radio"
								...
								<FormGroup row>
									...
									<Col sm={8}>
										...
										<FormText color="muted">Accepted formats: pdf, doc, txt. Max file size 7Mb</FormText>
									</Col>
								</FormGroup>
								{/* END File Select */}
								{/* START Textarea */}
							...
							<Form>
								...
								<FormGroup>
									<CustomInput
										...
										defaultChecked
									/>
									<CustomInput type="radio" name="operatingSystem" id="operatingSystem22" label="Windows" inline />
									<CustomInput
										type="radio"
										name="operatingSystem"
								...
								{/* START Textarea */}
								<FormGroup>
									<Input type="textarea" name="text" placeholder="Enter Your Message..." className="mb-2" />
									<CustomInput
										type="checkbox"
										id="iConfirm3"
										label="I confirm that I have read the Terms."
						...
						<CardBody>
							...
							<Form>
								...
								<FormGroup>
									...
									<Input type="password" name="password" id="inputPassword-2" placeholder="Password..." />
								</FormGroup>
								{/* END Input */}
								{/* START Radios */}
								<FormGroup>
									...
									<div>
										<CustomInput
											...
											defaultChecked
										/>
										<CustomInput type="radio" id="operatingSystem2" name="operatingSystem" label="Windows" inline />
										<CustomInput
											type="radio"
											id="operatingSystem3"
											name="operatingSystem"
