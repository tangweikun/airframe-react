...
import { Container, Row, Card, CardBody, Badge, Table, CardTitle, Progress, Col } from "./../../../components";
...
const Monitor = () => (
	<Container>
		...
		<Row>
			...
			<Col lg={8}>
				<p>
					Nesciunt odit eius nihil molestiae tenetur earum enim quidem. Aperiam non sapiente voluptatum in doloremque
					rerum magnam quae sed. Quisquam eos non voluptate sapiente qui temporibus harum in illo. Aliquid at dolor
					labore. Qui error modi.
				</p>
