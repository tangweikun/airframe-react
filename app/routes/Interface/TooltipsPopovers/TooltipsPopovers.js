			...
			<Row>
				<Col lg={12}>
					<HeaderDemo
						...
						subTitle={
							<React.Fragment>A rendered modal with header, body, and set of actions in the footer.</React.Fragment>
						}
					/>
				</Col>
			</Row>
			...
			<Row>
				<Col lg={12}>
					<HeaderDemo
						...
						subTitle={
							<React.Fragment>
								Four options are available: <code>top</code>, <code>right</code>, <code>bottom</code>, and{" "}
