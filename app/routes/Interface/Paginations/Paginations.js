					...
					<HeaderDemo
						...
						subTitle={
							<React.Fragment>
								...
								screen reader support with <code>aria</code> attributes and the <code>.sr-only</code> utility.
							</React.Fragment>
						}
					/>
				</Col>
			...
			<Row>
				<Col lg={12}>
					<HeaderDemo
						...
						subTitle={
							<React.Fragment>
								Fancy larger or smaller pagination? Add <code>.pagination-lg</code> or <code>.pagination-sm</code>
