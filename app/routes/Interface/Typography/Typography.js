				...
				<Col lg={6}>
					<Card className="mb-3">
						<CardBody>
							...
							<p className="card-text">
								Use any of these color variables as they are or reassign them to more meaningful variables for your
								project.
							</p>
							<div>
					...
					<Card className="mb-3">
						<CardBody>
							...
							<p className="card-text">Colors are often used for social media.</p>
							<div>
				...
				<Col lg={6}>
					<Card className="mb-3">
						<CardBody>
							...
							<p className="card-text">
								Grayscale colors provide quick access to commonly used shades of black while semantic include various
								colors assigned to meaningful contextual values.
							</p>
							<div>
				...
				<Col lg={6}>
					<Card className="mb-3">
						<CardBody>
							...
							<p className="card-text">
								Just add class/helper <code>.fw-300</code> to <code>&lt;h1&gt;</code>- <code>&lt;h6&gt;</code>.
							</p>
							<div>
				...
				<Col lg={6}>
					...
					<Card className="mb-3">
						<CardBody>
							...
							<p className="card-text">Transform text in components with text capitalization classes.</p>
				...
				<Col lg={6}>
					...
					<Card className="mb-3">
						<CardBody>
							...
							<div className="row">
								<div className="col-3 text-truncate">Praeterea iter est quasdam res quas ex communi.</div>
							</div>
					...
					<Card className="mb-3">
						<CardBody>
							...
							<div>
								<p className="card-text">Quickly change the weight (boldness) of text or italicize text.</p>
				...
				<Col lg={6}>
					<Card className="mb-3">
						<CardBody>
							...
							<p className="card-text">
								Wrap inline snippets of code with <code>&lt;code&gt;</code>. Be sure to escape HTML angle brackets.
							</p>
						</CardBody>
					</Card>
					<Card className="mb-3">
				...
				<Col lg={6}>
					...
					<Card className="mb-3">
						<CardBody>
							...
							<p className="card-text">
								Use <code>&lt;pre&gt;</code>s for multiple lines of code. Once again, be sure to escape any angle
								brackets in the code for proper rendering. You may optionally add the <code>.pre-scrollable</code>{" "}
